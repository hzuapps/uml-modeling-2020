...
## 4、实验结果
![UML](https://github.com/AngleBeatQAQ/uml-modeling-2020/blob/master/students/1714080902425/UseCaseDiagram2.jpg)
    图1:B2C购物车系统的用例图
...
~| 2. 系统会显示商品的库存信息和价钱  | 
~| 3. 买家在商品下方点击“添加到购物车”按钮，系统将其添加到购物车  |   
~| 4. 买家选择好商品后进入购物车页面  |      
